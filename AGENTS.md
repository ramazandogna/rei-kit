...
A Vue 3 + Tailwind 4 component kit. 88 components across six entry points,
...
| `rei-kit/web`      | A wide site with a header and a mouse                       | `BaseAccordion` `BaseBreadcrumb` `BaseDisclosure` `BaseModal` `BasePagination` `BaseSplitter` `BaseTabs` `BaseToolbar` `BaseTooltip` `BaseTree` `CommandMenu` `DataTable` `NavLinks` `ResponsiveDialog` `TransferList`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
