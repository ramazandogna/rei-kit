...
A Vue 3 + Tailwind 4 component kit. 94 components across six entry points,
...
| `rei-kit/web`      | A wide site with a header and a mouse                       | `BaseAccordion` `BaseBreadcrumb` `BaseContextMenu` `BaseDisclosure` `BaseDrawer` `BaseModal` `BasePagination` `BaseSplitter` `BaseTabs` `BaseToolbar` `BaseTooltip` `BaseTree` `CommandMenu` `DataTable` `MegaMenu` `NavLinks` `ResponsiveDialog` `TransferList`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
