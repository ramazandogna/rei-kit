...
**One kit. Every look.** 95 accessible components for Vue 3 and Tailwind 4.
...
| ---------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Open for extension, closed for edits** | A new look is a token, a material or a palette — never an edit to a component. Materials and palettes restyle all 95 without touching one, and a test fails if a component holds a colour.                                                                                                                                              |
